...
def remove_entity(list_id: str, entity: Union[str, tuple[str, str]]):
    ...
    with Progress(
        ...
        try:
            ...
            err.message = f"Failed to remove entity '{entity}'. {api_error_cause(err)}"
            raise err
        if result.result == 'removed':
            print(f'{entity} removed')
        elif result.result == 'unchanged':
            print(f'{entity} was not found')
