...
ARCH_FILE_TAGS = {
    'pe', 'pe32', 'pe64', 'x86', 'x64', 'elf', 'mach-o', 'apk', 'dex',
    'office', 'doc', 'docx', 'xls', 'xlsx', 'pdf', 'powershell', 'vbs',
    'js', 'jscript', 'script', 'bat', 'cmd', 'hta', 'jar', 'zip', 'archive',
    'iso', 'img', 'lnk', 'dll', 'exe', 'sh', 'ps1', 'msi', 'wsf', 'vhd',
    'rar', 'msg',
}

PLATFORM_PACKER_TAGS = {
    'linux', 'macos', 'android', 'windows', 'upx', 'packed', 'obfuscated',
    'armv7', 'armv8', 'arm', 'mips', 'mipsel',
}
