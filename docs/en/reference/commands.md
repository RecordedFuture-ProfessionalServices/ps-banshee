...
<dl class="commands-reference">
    ...
    <dt><a href="#banshee-sandbox-search"><code>banshee sandbox search</code></a></dt><dd><p>Search samples by hash, family, tag, botnet, wallet, network indicator, or a raw Triage query</p></dd>
    <dt><a href="#banshee-sandbox-get"><code>banshee sandbox get</code></a></dt><dd><p>Fetch a summary for a single sandbox sample by ID</p></dd>
    <dt><a href="#banshee-sandbox-download"><code>banshee sandbox download</code></a></dt><dd><p>Download the original submitted bytes for one or more sample IDs (wrapped in AES-encrypted ZIP archives)</p></dd>
...
<dl class="commands-reference">
    <dt id="banshee-sandbox-download--sample-ids"><a href="#banshee-sandbox-download--sample-ids"><code>SAMPLE_IDS</code></a></dt><dd><p>One or more sample IDs (or read from stdin, whitespace-separated)</p></dd>
</dl>
...
<dl class="commands-reference">
    ...
    <p>Directory to save encrypted zip archives into (created if missing). Required.</p></dd>
    ...
    <p>Number of parallel download workers (1–16)</p>
    <p>Defaults to 1</p></dd>
