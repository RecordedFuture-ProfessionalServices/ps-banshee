...
## Solution
Retrieve and manage Recorded Future alerts directly from the terminal using [`banshee ca`](../../reference/commands.md#banshee-ca) and [`banshee pba`](../../reference/commands.md#banshee-pba) commands. 

- For Classic Alerts, use [`banshee ca search`](../../reference/commands.md#banshee-ca-search) with time filters and [`banshee ca update`](../../reference/commands.md#banshee-ca-update) for bulk status changes, note additions, and assignee updates. 
