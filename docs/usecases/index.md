# PS Banshee use cases overview

Below are some of the core use cases to get started:

- [Alerts Management](alerts/index.md)
- [Detection Rules](detection-rules/index.md)
- [Email Enrichment](email/index.md)
- [Entity Match](entity/index.md)
