...
> **Classic Alerts** - legacy rule-based alerts. IDs are short opaque strings of 6+ chars (e.g. `tybakN`). For automation/playbook-driven alerts (36-char UUID IDs with optional `task:` prefix, categories like `domain_abuse` / `third_party_risk` / etc.), use [`pba`](https://recordedfuture-professionalservices.github.io/ps-banshee/knowledge-base/pba/index.md) instead.
>
