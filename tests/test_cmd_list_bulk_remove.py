...
def test_list_bulk_remove_no_args():
...
def test_http_errors():
    ...
    with patch.object(EntityList, 'remove', side_effect=list_api_error):
        result = runner.invoke(app, args=[COMMAND, 'report:wpHivJ', 'ip:8.8.8.8'])
...
@pytest.mark.vcr
def test_list_bulk_remove_more_than_100_entities():
...
@pytest.mark.skip(reason="This test doesn't wok correctly with multithreading")
@pytest.mark.vcr
def test_list_bulk_remove_fewer_than_100_entities():
