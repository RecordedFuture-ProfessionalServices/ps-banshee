...
- Sandbox mutating commands (`submit`, `delete`, `set-profile`, `profile create/update/delete`) were not live-tested in this refresh.
...
| `sandbox` | [sandbox.md](sandbox.md) | Submit files and URLs for sandbox analysis; retrieve reports; manage profiles |
